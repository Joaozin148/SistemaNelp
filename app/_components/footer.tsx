      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            <a href="#" className="flex items-center justify-center gap-2 bg-[#FFD600] hover:bg-yellow-400 text-[#222] font-semibold py-3 rounded transition"><FaFacebook /> Facebook</a>
            <a href="#" className="flex items-center justify-center gap-2 bg-[#FFD600] hover:bg-yellow-400 text-[#222] font-semibold py-3 rounded transition"><FaInstagram /> Instagram</a>
            <a href="#" className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-green-500 text-white font-semibold py-3 rounded transition"><FaWhatsapp /> Whatsapp</a>
          </div>
        </div>
      </div>
